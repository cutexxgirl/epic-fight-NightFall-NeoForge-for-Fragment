...
import com.hm.efn.client.model.geo.JudgementCutPerfectModel;
...
public class JudgementCutPerfectRenderer extends GeoEntityRenderer<JudgementCutPerfect> {
   @Nullable
   private RenderType cachedEmissiveRenderType;

   public JudgementCutPerfectRenderer(Context renderManager) {
      super(renderManager, new JudgementCutPerfectModel());
   }

   public void render(
      JudgementCutPerfect entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight
   ) {
   ...
   public void actuallyRender(
      PoseStack poseStack,
      JudgementCutPerfect animatable,
      BakedGeoModel model,
