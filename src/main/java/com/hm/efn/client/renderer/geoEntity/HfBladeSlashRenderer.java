...
import com.hm.efn.client.model.geo.HfBladeSlashModel;
...
public class HfBladeSlashRenderer extends GeoEntityRenderer<HfBladeSlash> {
   @Nullable
   private RenderType cachedEmissiveRenderType;

   public HfBladeSlashRenderer(Context renderManager) {
      super(renderManager, new HfBladeSlashModel());
   }

   public void render(HfBladeSlash entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {
