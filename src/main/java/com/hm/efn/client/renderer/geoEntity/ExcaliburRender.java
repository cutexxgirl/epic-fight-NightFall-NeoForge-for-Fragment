...
import com.hm.efn.client.model.geo.ExcaliburModel;
...
public class ExcaliburRender extends GeoEntityRenderer<Excalibur> {
   @Nullable
   private RenderType cachedEmissiveRenderType;

   public ExcaliburRender(Context renderManager) {
      super(renderManager, new ExcaliburModel());
   }

   public void render(Excalibur entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {
