...
import com.hm.efn.client.model.geo.SoulHuntLightningModel;
...
public class SoulHuntLightningRender extends GeoEntityRenderer<SoulHuntLightning> {
   @Nullable
   private RenderType cachedEmissiveRenderType;

   public SoulHuntLightningRender(Context renderManager) {
      super(renderManager, new SoulHuntLightningModel());
   }

   public void render(
      SoulHuntLightning entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight
   ) {
