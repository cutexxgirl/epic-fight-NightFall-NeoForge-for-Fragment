...
@OnlyIn(Dist.CLIENT)
public class RenderMurasama extends RenderItemBase {
   ...
   public RenderMurasama(JsonElement jsonElement) {
      super(jsonElement);
   ...
   public void renderItemInHand(
      ...
      if (livingEntityPatch != null) {
         ...
         if (livingEntityPatch instanceof PlayerPatch) {
            ...
            useSheathMesh = customData.copyTag().getInt("murasama_sheath") == 1;
         }
