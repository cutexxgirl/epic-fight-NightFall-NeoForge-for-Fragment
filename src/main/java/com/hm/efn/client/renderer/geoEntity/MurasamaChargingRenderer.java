...
import com.hm.efn.client.model.geo.MurasamaChargingModel;
...
public class MurasamaChargingRenderer extends GeoEntityRenderer<MurasamaCharging> {
   @Nullable
   private RenderType cachedEmissiveRenderType;

   public MurasamaChargingRenderer(Context renderManager) {
      super(renderManager, new MurasamaChargingModel());
   }

   public void render(
      MurasamaCharging entity, float entityYaw, float partialTick, PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight
   ) {
