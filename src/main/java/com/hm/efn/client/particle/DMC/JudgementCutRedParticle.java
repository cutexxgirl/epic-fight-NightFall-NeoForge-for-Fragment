...
public class JudgementCutRedParticle extends NoRenderParticle {
   public JudgementCutRedParticle(ClientLevel level, double x, double y, double z, double rx, double ry, double rz) {
   ...
   public void tick() {
      ...
      for (int i = 0; i < 2; i++) {
         ...
         RenderUtils.AddParticle(
            this.level,
            new JCBladeRedTrail(this.level, sx + this.x, sy + this.y + 1.2, sz + this.z, -ex - sx, ey - sy, -ez - sz)
         );
      }
   }
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new JudgementCutRedParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
      }
   }
}
