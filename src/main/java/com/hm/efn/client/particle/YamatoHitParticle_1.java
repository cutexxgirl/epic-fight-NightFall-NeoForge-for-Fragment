...
@OnlyIn(Dist.CLIENT)
public class YamatoHitParticle_1 extends NoRenderParticle {
   public YamatoHitParticle_1(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
      super(world, x, y, z);
      ...
      this.level.addParticle((ParticleOptions)EFNParticles.YAMATO_CUT_1.get(), this.x, this.y + 1.0, this.z, 0.0, 0.0, 0.0);
      double d = 0.2F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new YamatoHitParticle_1(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
      }
   }
}
