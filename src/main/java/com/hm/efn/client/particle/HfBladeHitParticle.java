...
public class HfBladeHitParticle extends NoRenderParticle {
   public HfBladeHitParticle(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
      super(world, x, y, z);
      ...
      this.level.addParticle((ParticleOptions)EFNParticles.HF_BLADE_CUT.get(), this.x, this.y, this.z, 0.0, 0.0, 0.0);
      double d = 0.2F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      public Particle createParticle(
         ...
         return new HfBladeHitParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
      }
   }
}
