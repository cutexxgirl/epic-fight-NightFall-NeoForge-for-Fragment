...
@OnlyIn(Dist.CLIENT)
public class SlashColorParticle extends HitParticle {
   private float hue = this.random.nextFloat();

   public SlashColorParticle(ClientLevel world, double x, double y, double z, SpriteSet animatedSprite) {
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new SlashColorParticle(worldIn, x, y, z, this.spriteSet);
      }
   }
}
