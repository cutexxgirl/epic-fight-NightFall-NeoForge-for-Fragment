...
@OnlyIn(Dist.CLIENT)
public class FireHitParticle extends NoRenderParticle {
   public FireHitParticle(ClientLevel world, double x, double y, double z, double width, double height, double _null) {
      super(world, x, y, z);
      ...
      this.level.addParticle((ParticleOptions)EFNParticles.FIRE_CUT.get(), this.x, this.y, this.z, 0.0, 0.0, 0.0);
      double d = 0.2F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new FireHitParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
      }
   }
}
