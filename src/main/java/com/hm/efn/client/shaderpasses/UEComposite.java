...
public class UEComposite extends PostPassBase {
   ...
   public void process(RenderTarget inTarget, RenderTarget outTarget, RenderTarget blur1, RenderTarget blur2, RenderTarget blur3, RenderTarget blur4) {
      ...
      this.effect.setSampler("BlurTexture1", blur1::getColorTextureId);
      this.effect.setSampler("BlurTexture2", blur2::getColorTextureId);
      this.effect.setSampler("BlurTexture3", blur3::getColorTextureId);
      this.effect.setSampler("BlurTexture4", blur4::getColorTextureId);
      this.effect.apply();
