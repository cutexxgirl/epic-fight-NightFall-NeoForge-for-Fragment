...
@OnlyIn(Dist.CLIENT)
public class DMGEffek {
   public static final ResourceLocation DMGEFFEK = ResourceLocation.fromNamespaceAndPath("efn", "dmg");

   public static void playDMG(DMGEffek.Type type, Level level, double x, double y, double z, float radius, Entity entity) {
   ...
   public static Particle createParticleWrapper(
      DMGEffek.Type type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz, float radius
   ) {
   ...
   public record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final DMGEffek.Type LEVEL1 = new DMGEffek.Type(DMGEffek.DMGEFFEK, 1.25F);
   }
}
