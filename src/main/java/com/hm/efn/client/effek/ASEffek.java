...
@OnlyIn(Dist.CLIENT)
public class ASEffek {
   public static final ResourceLocation ASEFFEK = ResourceLocation.fromNamespaceAndPath("efn", "as");

   public static void playAS(ASEffek.Type type, Level level, double x, double y, double z, float radius, Entity entity) {
   ...
   public static Particle createParticleWrapper(
      ASEffek.Type type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz, float radius
   ) {
   ...
   public record Type(ResourceLocation effekId, float intrinsicRadius) {
      public static final ASEffek.Type LEVEL1 = new ASEffek.Type(ASEffek.ASEFFEK, 1.25F);
   }
}
