...
public class HfBladeCharging extends GeoVFXEntity {
   ...
   private static final MurasamaAttackAnimation[] CHARGING_ANIMATIONS = new MurasamaAttackAnimation[]{
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_Y_CHARGE.get(),
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_Y_CHARGE_THROUGH.get(),
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_Y_CHARGE_AIR.get(),
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_XY_CHARGE.get(),
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_XXY_CHARGE.get(),
      (MurasamaAttackAnimation)EFNHfBladeAnimations.HF_BLADE_XXXY_CHARGE.get()
   };

   public static HfBladeCharging createEntity(EntityType<? extends GeoVFXEntity> type, Level level) {
      return new HfBladeCharging(type, level);
   }

   public HfBladeCharging(EntityType<? extends PathfinderMob> type, Level level) {
      super(type, level);
   }

   public HfBladeCharging(EntityType<? extends PathfinderMob> type, Level level, double x, double y, double z) {
      super(type, level, x, y, z);
   }

   public HfBladeCharging(EntityType<? extends PathfinderMob> type, Level level, double x, double y, double z, float yRot) {
      super(type, level, x, y, z, yRot);
   }

   public HfBladeCharging(EntityType<? extends PathfinderMob> type, Level level, double x, double y, double z, float yRot, LivingEntity owner) {
