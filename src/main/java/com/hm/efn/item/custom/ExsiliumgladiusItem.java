...
public class ExsiliumgladiusItem extends WeaponItem {
   public ExsiliumgladiusItem(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
   ...
   public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, @NotNull List<Component> pTooltipComponents, @NotNull TooltipFlag pIsAdvanced) {
      pTooltipComponents.add(Component.translatable("item.efn.exsiliumgladius.description1"));
