...
public class EFNDodgeAnimation_ROLL_MOB extends ActionAnimation {
   ...
   public EFNDodgeAnimation_ROLL_MOB(float transitionTime, AnimationAccessor<? extends ActionAnimation> accessor, AssetAccessor<? extends Armature> armature) {
      this(transitionTime, 10.0F, accessor, armature);
   }

   public EFNDodgeAnimation_ROLL_MOB(
