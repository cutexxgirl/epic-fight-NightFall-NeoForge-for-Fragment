...
public class EFNClawAnimations_N {
   ...
   public static void build(AnimationBuilder builder) {
      NF_CLAW_IDLE = builder.nextAccessor("biped/nf_claw_n/nf_claw_idle", accessor -> new StaticAnimation(true, accessor, Armatures.BIPED));
      NF_CLAW_WALK = builder.nextAccessor("biped/nf_claw_n/nf_claw_walk", accessor -> new AvalonMovementAnimation(0.1F, true, accessor, Armatures.BIPED, 1.0F));
      NF_CLAW_RUN = builder.nextAccessor("biped/nf_claw_n/nf_claw_run", accessor -> new AvalonMovementAnimation(0.1F, true, accessor, Armatures.BIPED, 0.8F));
      NF_CLAW_AUTO1 = builder.nextAccessor(
         "biped/nf_claw_n/nf_claw_auto1",
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     26, 34, 40, InteractionHand.MAIN_HAND, 0.8F, 0.8F, ((HumanoidArmature)Armatures.BIPED.get()).toolR, CLAW
                  )
               }
            )
               ...
               new AnimationEvent[]{
                  InTimeEvent.create(
                     ...
                     (entityPatch, self, params) -> {
                        if (EffekUnits.VFXENABLE() && ((LivingEntity)entityPatch.getOriginal()).hasEffect(EFNMobEffectRegistry.CLAW)) {
      ...
      NF_CLAW_AUTO2 = builder.nextAccessor(
         ...
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     19, 29, 32, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).toolR, CLAW
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     39, 55, 65, InteractionHand.MAIN_HAND, 0.7F, 0.7F, ((HumanoidArmature)Armatures.BIPED.get()).toolL, CLAW
                  )
               }
            )
            .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
      ...
      NF_CLAW_AUTO3 = builder.nextAccessor(
         ...
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     39, 51, 65, InteractionHand.MAIN_HAND, 1.0F, 1.0F, ((HumanoidArmature)Armatures.BIPED.get()).rootJoint, CLAW_AUTO3
                  )
               }
            )
            .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
      ...
      NF_CLAW_DASH = builder.nextAccessor(
         ...
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     20, 27, 45, InteractionHand.MAIN_HAND, 0.5F, 0.5F, ((HumanoidArmature)Armatures.BIPED.get()).toolL, CLAW
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     23, 30, 45, InteractionHand.MAIN_HAND, 0.5F, 0.5F, ((HumanoidArmature)Armatures.BIPED.get()).toolR, CLAW
                  )
               }
            )
            .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
      ...
      NF_CLAW_AIRSLASH = builder.nextAccessor(
         "biped/nf_claw_n/nf_claw_airslash",
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               0.1F,
               accessor,
               Armatures.BIPED,
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     20, 26, 40, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).toolL, CLAW
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     41, 48, 56, InteractionHand.MAIN_HAND, 0.7F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).toolR, CLAW
                  )
               }
            )
            .addProperty(AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
      ...
      NF_CLAW_BEASTROAR = builder.nextAccessor(
         "biped/nf_claw_n/nf_claw_beastroar",
         accessor -> (AvalonAttackAnimation)new AvalonAttackAnimation(
               0.1F,
               accessor,
               Armatures.BIPED,
               ...
               new AvalonPhase[]{
                  AvalonAnimationUtils.createSimplePhase(
                     27, 33, 33, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).rootJoint, CLAW_ROAR
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     33, 39, 39, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).rootJoint, CLAW_ROAR
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     39, 45, 45, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).rootJoint, CLAW_ROAR
                  ),
                  AvalonAnimationUtils.createSimplePhase(
                     45, 51, 60, InteractionHand.MAIN_HAND, 0.6F, 0.6F, ((HumanoidArmature)Armatures.BIPED.get()).rootJoint, CLAW_ROAR
                  )
               }
            )
            .addProperty(AttackPhaseProperty.SWING_SOUND, (SoundEvent)EpicFightSounds.WHOOSH_BIG.get())
