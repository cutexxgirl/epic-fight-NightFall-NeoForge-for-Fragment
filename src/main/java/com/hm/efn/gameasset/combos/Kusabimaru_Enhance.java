...
public class Kusabimaru_Enhance {
   public static Skill kusabimaru_enhance;
   ...
   public static void BuildSkills(SkillBuildEvent event) {
      if (ModList.get().isLoaded("efn_enhance")) {
         ...
         ComboNode Auto1 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.KUSABIMARU_AUTO1)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .setPriority(1)
            .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.65F));
         ComboNode Auto2 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.KUSABIMARU_AUTO2)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.55F));
         ComboNode Auto3 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.KUSABIMARU_AUTO3)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.7F));
         ComboNode Auto4 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.KUSABIMARU_AUTO4)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.55F));
         ComboNode Auto5 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.KUSABIMARU_AUTO5)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.55F));
         ComboNode Skill = EFNComboNodes.create(() -> EFN_ESekiroAnimations.DRAGON_FLASH)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .setPriority(1)
            .setNotCharge(true)
         ...
         ComboNode Skill_Combo_1 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.ICHIMONJI_1)
            .setPriority(5)
            .setNotCharge(true)
            ...
            .addTimeEvent(TimeEvents.timeConsumeStamina(0.3F, -3.0F));
         ComboNode Skill_Combo_2 = EFNComboNodes.create(() -> EFN_ESekiroAnimations.ICHIMONJI_2)
            .setPriority(5)
            .setNotCharge(true)
            .setDamageMultiplier(ValueModifier.multiplier(1.5F))
            .setStunTypeModifier(StunType.LONG)
            ...
            .addTimeEvent(TimeEvents.timeConsumeStack(0.2F, 1))
            .addTimeEvent(TimeEvents.timeConsumeStamina(0.3F, -3.0F));
         ComboNode Skill_Dash = EFNComboNodes.create(() -> EFN_ESekiroAnimations.SHADOW_RUSH)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .setPriority(5)
            .setNotCharge(true)
         ...
         ComboNode Skill_Air = EFNComboNodes.create(() -> EFN_ESekiroAnimations.SAKURA_DANCE)
            .setDamageMultiplier(ValueModifier.multiplier(1.2F))
            .setPriority(5)
            .setNotCharge(true)
            .addCondition(new EFNStackCondition(2, Integer.MAX_VALUE))
         ...
         Auto5.key3(Skills);
         kusabimaru_enhance = registryWorker.build(
