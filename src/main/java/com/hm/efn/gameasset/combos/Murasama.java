...
public class Murasama {
   public static Skill Murasama;
   public static Skill Murasama_Passive;
   public static ComboNode DodgeCounter;
   public static ComboNode Air_Dodge;
   public static ComboNode Murasama_root;
   ...
   public static void BuildSkills(SkillBuildEvent event) {
      ...
      Murasama_root = ComboNode.create();
      Y_CHARGE_AIR = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_CHARGE_AIR)
      ...
      XY_CHARGE = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XY_CHARGE)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNKeyLongPressCondition(EFNKeyLongPressCondition.TargetKey.KEY3))
         .setNotCharge(true)
         .setDamageMultiplier(ValueModifier.multiplier(2.5F))
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      XXY_CHARGE = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXY_CHARGE)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNKeyLongPressCondition(EFNKeyLongPressCondition.TargetKey.KEY3))
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      XXXY_CHARGE = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXXY_CHARGE)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNKeyLongPressCondition(EFNKeyLongPressCondition.TargetKey.KEY3))
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode SHEATH_IN = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_SHEATH_IN)
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .setPriority(1);
      ComboNode SHEATH_IN_RUN = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_SHEATH_IN_RUN)
         .addCondition(new EFNBlockingCondition(false))
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new MurasamaSheathCondition(false))
         .addCondition(new DoubleTapSprintCondition(false, true))
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .setPriority(2);
      ComboNode SWORD_OUT = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_SWORD_OUT)
         .addCondition(new EFNBlockingCondition(false))
         .addCondition(new MurasamaZansetsuCondition(false))
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .setPriority(1);
      ComboNode TAUNT = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_TAUNT)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNSneakKeyCondition())
         .setCanBeInterrupt(false)
         .setPriority(10000);
      ComboNode COUNTER = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_COUNTER)
         .addCondition(new MurasamaZansetsuCondition(false))
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Y_KICK = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_KICK_Y)
         .addCondition(new MurasamaZansetsuCondition(false))
      ...
      ComboNode Y_DASH_SP = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_DASH_Y_SP)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNSprintingCondition())
      ...
      ComboNode Y_DASH = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_DASH_Y)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNSprintingCondition())
         .addCondition(new MurasamaSheathCondition(true))
         .addCondition(new EFNOnGroundCondition(false))
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Y_SHEATH = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XY)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new MurasamaSheathCondition(true))
         .setPriority(9)
      ...
      ComboNode Y_SHEATH_DASH = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_CHARGE)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new MurasamaSheathCondition(true))
         .addCondition(new EFNSneakKeyCondition())
      ...
      ComboNode Y_SHEATH_DASH_THROUGH = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_CHARGE_THROUGH)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new MurasamaSheathCondition(true))
         .addCondition(new EFNSneakKeyCondition())
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.45F, false, true));
      ComboNode Y_CHARGE = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_CHARGE)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNKeyLongPressCondition(EFNKeyLongPressCondition.TargetKey.KEY3))
         .setNotCharge(true)
         .setPriority(1)
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Y_CHARGE_THROUGH = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_CHARGE_THROUGH)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNKeyLongPressCondition(EFNKeyLongPressCondition.TargetKey.KEY3))
         .addCondition(new EFNUpKeyCondition())
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.applyEffectAtTime(EFNMobEffectRegistry.SIN_STUN_IMMUNITY, 40, 1, 0.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Y_AIR = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y_AIR)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNAirborneCondition(true, 1.0F))
         .setNotCharge(true)
         .setPriority(20)
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode SHEATH_X = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new MurasamaSheathCondition(true))
         .setPriority(4)
         ...
         .setConvertTime(-0.3F)
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.5F, false, true));
      ComboNode DASH_X = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_DASH_X)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new MurasamaSheathCondition(true))
         ...
         .setImpactMultiplier(1.1F)
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode DASH_X_SP = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_DASH_X)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .addCondition(new DoubleTapSprintCondition())
         .addCondition(new SprintingCondition())
         ...
         .setImpactMultiplier(1.1F)
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode X = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_X)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(1)
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XY = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XY)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(5)
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XY_DASH_X = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XY)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(5)
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.TimeSimulationComboNodeEvent(0.25F, XY_CHARGE))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XX = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XX)
         .addCondition(new MurasamaZansetsuCondition(false))
         .setDamageMultiplier(ValueModifier.multiplier(0.85F))
         .setImpactMultiplier(0.85F)
         .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.4F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XXY = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXY)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(5)
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XXX = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXX)
         .addCondition(new MurasamaZansetsuCondition(false))
         .setDamageMultiplier(ValueModifier.multiplier(0.8F))
         .setImpactMultiplier(1.2F)
         .addTimeEvent(TimeEvents.TimeSimulationAttackEvent(0.3F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XXXY = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXXY)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(5)
         .setNotCharge(true)
         ...
         .addHitEvent(HitEvents.createHitSound(() -> EpicFightSounds.BLADE_RUSH_FINISHER.get()))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode XXXX = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XXXX)
         .addCondition(new MurasamaZansetsuCondition(false))
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Air_X = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_X_AIR)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNAirborneCondition(true, 1.0F))
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Air_XX = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XX_AIR)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNAirborneCondition(true, 1.0F))
         .addCondition(new EFNStaminaCondition(2.0F, true))
         .setPriority(10)
         ...
         .addTimeEvent(TimeEvents.timeConsumeStamina(0.2F, 2.0F))
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Air_XX_DOUBLEJUMP = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_XX_AIR)
         .addCondition(new MurasamaZansetsuCondition(false))
      ...
      ComboNode Y = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
         .setPriority(1)
         .setNotCharge(true)
         ...
         .addTimeEvent(TimeEvents.setMurasamaSheath(0.1F, false, true));
      ComboNode Y_COMBO = EFNComboNodes.create(() -> EFNMurasamaAnimations.HF_MURASAMA_Y)
         .addCondition(new MurasamaZansetsuCondition(false))
         .addCondition(new EFNOnGroundCondition(false))
      ...
      Murasama_root.key1(BasicAttack);
      Murasama_root.key1_3(Skill);
      Murasama_root.key3(Skill);
      Murasama_root.key4(Sheath);
      ...
      XXXX.key1_3(Skill);
      XXXX.key3(Skill);
      Murasama = registryWorker.build(
         "murasama",
         MurasamaInnate::new,
         ComboBasicAttack.createComboBasicAttack(MurasamaInnate::new).setMaxPressTime(1).setReserveTime(11).setCombo(Murasama_root).setShouldDrawGui(true)
      );
      Murasama_Passive = registryWorker.build(
         "murasama_passive", MurasamaPassive::new, PassiveSkill.createPassiveBuilder(builder -> new MurasamaPassive(builder)).setCategory(SkillCategories.WEAPON_PASSIVE).setResource(Resource.NONE)
      );
   }
}
